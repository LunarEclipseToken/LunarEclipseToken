    ...
    <StyledContentContainer>
      <StyledGrid>
        ...
        <StyledArticle>
          ...
          <p>We are tired of all the scams that happen among tokens. So we decided to take matters into our own hands. That's why we created ECLIPSE, with the intention of being 100% safe from rug pulls. How? Because we, the devs have no rugs to pull. This token is for you, let's moon. This token is a fork of it's parent token Eclipse but with a 4% tax fees for more redistribution between holders.</p>
        </StyledArticle>
        <StyledArticle>
          <h4>
            Tokenomics
          ...
          <div className="content">
            ...
            <div className="flex">
              ...
              <div className="right">600,000,000,000,000</div>
            </div>
            <div className="flex">
              <div className="left">
                <div className="iconContainer">
              ...
              <div className="right">400,000,000,000,000</div>
            </div>
            <div className="flex">
              <div className="left">
                <div className="iconContainer">
        ...
        <StyledBigArticle>
          ...
          <div className="flexContent">
            ...
            <div className="items two">
              ...
              <p>Keep holding your Eclipse tokens, and you will earn more. For each transaction, a 4% fee is sent back to our beloved holders.</p>
            </div>
